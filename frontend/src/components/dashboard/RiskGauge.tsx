...
import { TrendingUp, AlertTriangle, Calculator, X } from 'lucide-react';
...
export const RiskGauge: React.FC<RiskGaugeProps> = ({ metrics, onTriggerMitigation }) => {
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-between pb-2 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 font-body">
                S<sub>risk</sub>(t) = 0.60·P<sub>synth</sub> + 0.25·C<sub>context</sub> + 0.15·A<sub>anomaly</sub>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              title="View Mathematical Threat Formula Diagram"
              className="p-1.5 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 text-[10px] font-bold font-mono flex items-center gap-1 transition-colors cursor-pointer"
            >
      ...
      {/* Interactive Risk Formula Explanation Modal */}
      {showFormulaModal && (
          ...
          <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-4 sm:p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-sm font-bold text-slate-900 font-heading">
                    Mathematical Threat Fusion Engine Formula
                  </h3>
                  <p className="text-[11px] text-slate-500 font-body">
                    Exact weight decomposition and real-time Bayesian scoring architecture
                  </p>
                </div>
              </div>
              <button
